...
<div class="tf-form-wrap">
    ...
    <div class="tf-form-header">
        ...
        <p>Organisez votre journée avec clarté et élégance.</p>
    </div>
    ...
    <div class="tf-form-card">
        ...
        <form action="{{ route('tasks.store') }}" method="POST">
            ...
            <div class="tf-group">
                ...
                <input type="text" name="title" id="title" class="tf-input @error('title') is-invalid @enderror" value="{{ old('title') }}" placeholder="Ex: Finaliser le design system" required>
                @error('title')
            ...
            <div class="tf-group">
                ...
                <textarea name="description" id="description" class="tf-textarea @error('description') is-invalid @enderror" placeholder="Détails de la tâche...">{{ old('description') }}</textarea>
            </div>
            ...
            <div class="tf-row">
                <div class="tf-group">
                    ...
                    <select name="category_id" id="category_id" class="tf-select @error('category_id') is-invalid @enderror" required>
            ...
            <div class="tf-group">
                ...
                <input type="date" name="due_date" id="due_date" class="tf-date @error('due_date') is-invalid @enderror" value="{{ old('due_date') }}">
            </div>
    ...
    <div class="tf-form-footer">
        ...
        Les tâches créées sont synchronisées automatiquement.
    </div>
